...
Dgol1 = round(Dgol1, 3)
print('10.1', Dgol1, 'Диаметр поперечного сечения головки горелки, мм (для круглых отверстий)')
...
Dgol2 = round(Dgol2, 3)
print('10.2', Dgol2, 'Диаметр поперечного сечения головки горелки, мм (для прямоуголных отверстий)')
# Диаметр головки должен быть от 3,5 до 100
