...
v15 = component.getValueFromVariant('var', 'Coef. Burner nozzle flow')                        # коэф. расхода сопла горелки
v16 = component.getValueFromVariant('var', 'Coef. Loss of ejection tube (1.5 or 2.1 or 3)')   # коэф. потерь эжекционной трубки
v17 = component.getValueFromVariant('var', 'Burner cover temperature')                        # температура крышки горелки
v18 = component.getValueFromVariant('var', 'Coef. Heat transfer int. P. cover')               # коэф. теплоотдачи внутренней пов-ти крышки